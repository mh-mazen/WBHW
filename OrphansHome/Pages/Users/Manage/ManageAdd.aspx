<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ManageAdd.aspx.cs" Inherits="OrphansHome.Pages.Users.Manage.ManageAdd" %>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="title-single-box">
                        <h1 class="title-single">اضافة مستخدم 
                        </h1>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-a">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <asp:Button runat="server" ID="send" OnClick="send_Click" CssClass="btn btn-a" Text="اضافة المستخدم " />
                                    </div>

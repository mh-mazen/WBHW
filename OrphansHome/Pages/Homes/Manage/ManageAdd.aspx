<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ManageAdd.aspx.cs" Inherits="OrphansHome.Pages.Homes.Manage.ManageAdd" %>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="title-single-box">
                        <h1 class="title-single">اضافة دار ايتام 
                        </h1>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-a">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <label for="Manager">مدير الدار</label>
                                            <asp:DropDownList runat="server" ID="ManagerDrop" CssClass="form-control form-control-lg form-control-a">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator runat="server" ControlToValidate="ManagerDrop" ForeColor="Red" ErrorMessage="الرجاء اختيار مدير الدار"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
